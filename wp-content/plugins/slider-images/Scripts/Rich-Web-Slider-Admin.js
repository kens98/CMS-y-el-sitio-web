...
function jambCloneId(CloneNumber)
{
	...
	jQuery('.rich_web_SaveSl_Table3 tr').each(function(){
		...
		jQuery(this).find('td:nth-child(7) i').attr('onclick','jambDelId('+parseInt(parseInt(jQuery(this).index())+1)+')');
