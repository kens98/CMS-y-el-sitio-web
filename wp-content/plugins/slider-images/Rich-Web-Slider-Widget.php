 		...
 		function widget($args,$instance)
 		{
			...
			<?php }else if($Rich_Web_Slider_Effects[0]->slider_type=='Dynamic Slider'){ ?>
				...
				<style type="text/css">
					...
					.rSlider_<?php echo $Rich_Web_Slider_Manager[0]->id;?> .slide-styled_<?php echo $Rich_Web_Slider_Manager[0]->id;?> p { line-height:1.3; }
  			...
  			<?php }else if($Rich_Web_Slider_Effects[0]->slider_type=='Thumbnails Slider & Lightbox'){ ?>
				...
				<style type="text/css">
					...
					.anythingSlider<?php echo $Rich_Web_Slider_Manager[0]->id;?>-metallic .arrow { top: 50%; transform:translateY(-50%); -webkit-transform:translateY(-50%); -moz-transform:translateY(-50%); position: absolute; display: block; z-index: 100; }
					...
					.anythingSlider<?php echo $Rich_Web_Slider_Manager[0]->id;?>-metallic .anythingControls<?php echo $Rich_Web_Slider_Manager[0]->id;?> ul a { display: inline-block; padding: 0; text-decoration: none; text-align: center; outline: 0; box-sizing:border-box !important; -moz-box-sizing:border-box !important; -webkit-box-sizing:border-box !important; }
					...
					div.anythingControls<?php echo $Rich_Web_Slider_Manager[0]->id;?> { bottom: 25px; /* thumbnail images are larger than the original bullets; move it up */ }
					...
					.anythingSlider<?php echo $Rich_Web_Slider_Manager[0]->id;?>-metallic .thumbNav<?php echo $Rich_Web_Slider_Manager[0]->id;?> a span { visibility: visible; }
					...
					.anythingWindow ul li:before, .anythingControls<?php echo $Rich_Web_Slider_Manager[0]->id;?> ul li:before { content: '' !important; }
					...
					#RichWeb_TSL_slider<?php echo $Rich_Web_Slider_Manager[0]->id;?> { margin-left:0px !important; }					
					@media screen and (max-width:700px)
					{
				...
				<script type="text/javascript">
					jQuery(function(){
						...
						<?php } ?>
						<?php
							function trueFalse($boalone) { if($boalone == "true") { $boalone = true; } else { $boalone = false; } }
