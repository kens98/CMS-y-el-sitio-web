		...
		<div class='Table_Data_rich_web2_2'>
			...
			<table class='rich_web_SaveSl_Table_2 rich_web_SaveSl_Table_2_1' style="display:none;">
				...
				<tr>
					...
					<td>
						<label class="switch switch-light">
							<input class="switch-input" type="checkbox" name="" id="rich_web_Sl1_BoxS"/>
							<span class="switch-label" data-on="On" data-off="Off"></span> 
							<span class="switch-handle"></span> 
						</label>
					</td>
				...
				<tr>
					<td>
						<div class="range-slider">  
							<input class="range-slider__range" type="range" value="" id="rich_web_Sl1_IBW" name="" min="0" max="20">
					...
					<td>
						<div class="range-slider">  
							<input class="range-slider__range" type="range" value="" id="rich_web_Sl1_IBR" name="" min="0" max="500">
				...
				<tr>
					...
					<td>
						<div class="range-slider">  
							<input class="range-slider__range" type="range" value="" id="rich_web_Sl1_TFS" name="" min="8" max="48">
				...
				<tr>
					<td>
						<select class="rich_web_Select_Menu" id="rich_web_Sl1_TFF" name="">
				...
				<tr>
					...
					<td>
						<div class="range-slider">  
							<input class="range-slider__range" type="range" value="" id="rich_web_Sl1_ArPFT" name="" min="0" max="100">
				...
				<tr>
					<td>
						<div class="range-slider">  
							<input class="range-slider__range" type="range" value="" id="rich_web_Sl1_NavW" name="" min="0" max="20">
							<span class="range-slider__value" id="rich_web_Sl1_NavW_Span">0</span>
						</div>
					</td>
					<td>
						<div class="range-slider">  
							<input class="range-slider__range" type="range" value="" id="rich_web_Sl1_NavH" name="" min="0" max="20">
					...
					<td>
						<div class="range-slider">  
							<input class="range-slider__range" type="range" value="" id="rich_web_Sl1_NavBW" name="" min="1" max="5">
				...
				<tr>
					...
					<td>
						<div class="range-slider">  
							<input class="range-slider__range" type="range" value="" id="rich_web_Sl1_NavBR" name="" min="0" max="20">
			...
			<table class="rich_web_SaveSl_Table_2 rich_web_SaveSl_Table_2_2" style='display:none;'>	
				...
				<tr>
					...
					<td>
						<div class="range-slider">  
							<input class="range-slider__range" type="range" value="" id="rich_CS_Cont_Op" name="" min="0" max="100">
				...
				<tr>
					...
					<td>
						<div class="range-slider">  
							<input class="range-slider__range" type="range" value="" id="rich_CS_Video_TFS" name="" min="6" max="36">
				...
				<tr>
					<td>
						<select class="rich_web_Select_Menu" id="rich_CS_Video_TFF" name="">
							<?php for($i=0;$i<count($Rich_WebFontCount);$i++){ ?> 
								<option value="<?php echo $Rich_WebFontCount[$i]->Font_family;?>"><?php echo $Rich_WebFontCount[$i]->Font_family;?></option>
							<?php }?>
						</select>
				...
				<tr>
					...
					<td>
						<input type='text' id='rich_CS_Video_DC' class='alpha-color-picker' name="" value="">
					</td>	
					<td>
						<input type='text' id='rich_CS_Video_DSC' class='alpha-color-picker' name="" value="">
					</td>
					<td>
						<div class="range-slider">  
							<input class="range-slider__range" type="range" value="" id="rich_CS_Video_DFS" name="" min="6" max="36">
							<span class="range-slider__value" id="rich_CS_Video_TFS_Span">0</span>
						</div>
					</td>					
				</tr>
				...
				<tr>
					<td>
						<select class="rich_web_Select_Menu" id="rich_CS_Video_DFF" name="">
							<?php for($i=0;$i<count($Rich_WebFontCount);$i++){ ?> 
								<option value="<?php echo $Rich_WebFontCount[$i]->Font_family;?>"><?php echo $Rich_WebFontCount[$i]->Font_family;?></option>
							<?php }?>
						</select>
					...
					<td>
						<select class="rich_web_Select_Menu" id='rich_CS_Video_DTA' name="">
							<option value='left'>    Left    </option>
				 			<option value='right'>   Right   </option>
				 			<option value='center'>  Center  </option>
				...
				<tr>
					...
					<td>
						<div class="range-slider">  
							<input class="range-slider__range" type="range" value="" id="rich_CS_Video_W" name="" min="6" max="36">
				...
				<tr>
					<td>
						<div class="range-slider">  
							<input class="range-slider__range" type="range" value="" id="rich_CS_LFS" name="" min="8" max="36">
							<span class="range-slider__value" id="rich_CS_LFS_Span">0</span>
						</div>
					</td>
					<td>
						<select class="rich_web_Select_Menu" id="rich_CS_LFF" name="">
							<?php for($i=0;$i<count($Rich_WebFontCount);$i++){ ?> 
								<option value="<?php echo $Rich_WebFontCount[$i]->Font_family;?>"><?php echo $Rich_WebFontCount[$i]->Font_family;?></option>
							<?php }?>
						</select>
					...
					<td>
						<input type='text' id='rich_CS_LT' name="" value="">
					</td>
				</tr>
				<tr>
					<td>Background Color <span class="Rich_Web_SliderIm_Pro">(Pro)</span></td>
				...
				<tr>
					...
					<td>
						<div class="range-slider">  
							<input class="range-slider__range" type="range" value="" id="rich_CS_LBR" name="" min="0" max="20">
				...
				<tr>
					<td>
						<div class="range-slider">  
							<input class="range-slider__range" type="range" value="" id="rich_CS_Link_BW" name="" min="0" max="20">
				...
				<tr>
					...
					<td>
						<div class="range-slider">  
							<input class="range-slider__range" type="range" value="" id="rich_CS_AFS" name="" min="8" max="36">
			...
			<table class="rich_web_SaveSl_Table_2 rich_web_SaveSl_Table_2_3" style='display:none;'>
				...
				<tr>
					...
					<td>
						<div class="range-slider">  
							<input class="range-slider__range" type="range" value="" id="rich_fsl_Box_Shadow" name="" min="0" max="50">
				...
				<tr>
					...
					<td>
						<div class="range-slider">  
							<input class="range-slider__range" type="range" value="" id="rich_fsl_Desc_Size" name="" min="8" max="36">
							<span class="range-slider__value" id="rich_fsl_Desc_Size_Span">0</span>
						</div>
					</td>
					<td>
						<input type='text' id='rich_fsl_Desc_Color' class='alpha-color-picker' name="" value="">
					</td>
					<td>
						<select class="rich_web_Select_Menu" id="rich_fsl_Desc_Font_Family" name="">
							<?php for($i=0;$i<count($Rich_WebFontCount);$i++){ ?> 
								<option value="<?php echo $Rich_WebFontCount[$i]->Font_family;?>"><?php echo $Rich_WebFontCount[$i]->Font_family;?></option>
							<?php }?>
						</select>
				...
				<tr>
					<td>
						<select class="rich_web_Select_Menu" id='rich_fsl_Desc_Text_Align' name="">
							<option value='left'>   Left   </option>
							<option value='right'>  Right  </option>
				 			<option value='center'> Center </option>
						</select>
				...
				<tr>
					<td>
						<div class="range-slider">  
							<input class="range-slider__range" type="range" value="" id="rich_fsl_Title_Font_Size" name="" min="8" max="36">
					...
					<td>
						<select class="rich_web_Select_Menu" id="rich_fsl_Title_Font_Family" name="">
							<?php for($i=0;$i<count($Rich_WebFontCount);$i++){ ?> 
								<option value="<?php echo $Rich_WebFontCount[$i]->Font_family;?>"><?php echo $Rich_WebFontCount[$i]->Font_family;?></option>
							<?php }?>
						</select>
				...
				<tr>
					<td>
						<input type='text' id='rich_fsl_Link_Text'  name="" value="">
					</td>
					<td>
						<div class="range-slider">  
							<input class="range-slider__range" type="range" value="" id="rich_fsl_Link_Border_Width" name="" min="0" max="30">
				...
				<tr>
					<td>
						<div class="range-slider">  
							<input class="range-slider__range" type="range" value="" id="rich_fsl_Link_Font_Size" name="" min="8" max="36">
					...
					<td>
						<select class="rich_web_Select_Menu" id="rich_fsl_Link_Font_Family" name="">
							<?php for($i=0;$i<count($Rich_WebFontCount);$i++){ ?> 
								<option value="<?php echo $Rich_WebFontCount[$i]->Font_family;?>"><?php echo $Rich_WebFontCount[$i]->Font_family;?></option>
							<?php }?>
						</select>
				...
				<tr>
					...
					<td>
						<div class="range-slider">  
							<input class="range-slider__range" type="range" value="" id="rich_fsl_Title_Text_Shadow" name="" min="0" max="100">
				...
				<tr>
					<td>
						<div class="range-slider">  
							<input class="range-slider__range" type="range" value="" id="rich_fsl_Icon_Size" name="" min="10" max="45">
			...
			<table class="rich_web_SaveSl_Table_2 rich_web_SaveSl_Table_2_4" style='display:none;'>
				...
				<tr>
					...
					<td>
						<label class="switch switch-light">
							<input class="switch-input" type="checkbox" name="" id="Rich_Web_Sl_CT_BxSShow"/>
							<span class="switch-label" data-on="On" data-off="Off"></span> 
							<span class="switch-handle"></span> 
						</label>
					</td>
					<td>
						<label class="switch switch-light">
							<input class="switch-input" type="checkbox" name="" id="Rich_Web_Sl_CT_BxSType"/>
					...
					<td>
						<div class="range-slider">  
							<input class="range-slider__range" type="range" value="" id="Rich_Web_Sl_CT_BxS" name="" min="0" max="50">
				...
				<tr>
					<td>
						<div class="range-slider">  
							<input class="range-slider__range" type="range" value="" id="Rich_Web_Sl_CT_TFS" name="" min="8" max="48">
							<span class="range-slider__value" id="Rich_Web_Sl_CT_TFS_Span">0</span>
						</div>
					</td>
					<td>
						<select class="rich_web_Select_Menu" id="Rich_Web_Sl_CT_TFF" name="">
							<?php for($i=0;$i<count($Rich_WebFontCount);$i++){ ?> 
								<option value="<?php echo $Rich_WebFontCount[$i]->Font_family;?>"><?php echo $Rich_WebFontCount[$i]->Font_family;?></option>
							<?php }?>
						</select>
				...
				<tr>
					<td>
						<input type="text" class="rich_web_Select_Menu" name="" id="Rich_Web_Sl_CT_ArLeft" value="">
					</td>
					<td>
						<input type="text"  name="" id="Rich_Web_Sl_CT_ArRight" value="">
					</td>
					<td>
					...
					<td>
						<div class="range-slider">  
							<input class="range-slider__range" type="range" value="" id="Rich_Web_Sl_CT_ArTextFS" name="" min="8" max="48">
				...
				<tr>
					<td>
						<select class="rich_web_Select_Menu" id="Rich_Web_Sl_CT_ArTextFF" name="">
							<?php for($i=0;$i<count($Rich_WebFontCount);$i++){ ?> 
								<option value="<?php echo $Rich_WebFontCount[$i]->Font_family;?>"><?php echo $Rich_WebFontCount[$i]->Font_family;?></option>
							<?php }?>
						</select>
			...
			<table class="rich_web_SaveSl_Table_2 rich_web_SaveSl_Table_2_5" style='display:none;'>
				...
				<tr>
					<td>
						<label class="switch switch-light">
							<input class="switch-input" type="checkbox" name="" id="Rich_Web_Sl_SC_BoxShType"/>
							<span class="switch-label" data-on="1" data-off="2"></span> 
							<span class="switch-handle"></span> 
						</label>
					</td>
					<td>
						<div class="range-slider">  
							<input class="range-slider__range" type="range" value="" id="Rich_Web_Sl_SC_BoxSh" name="" min="0" max="50">
				...
				<tr>
					...
					<td>
						<div class="range-slider">  
							<input class="range-slider__range" type="range" value="" id="Rich_Web_Sl_SC_IBW" name="" min="0" max="10">
				...
				<tr>
					...
					<td>
						<div class="range-slider">  
							<input class="range-slider__range" type="range" value="" id="Rich_Web_Sl_SC_IBR" name="" min="0" max="100">
				...
				<tr>
					<td>
						<div class="range-slider">  
							<input class="range-slider__range" type="range" value="" id="Rich_Web_Sl_SC_ICBW" name="" min="0" max="10">
				...
				<tr>
					...
					<td>
						<div class="range-slider">  
							<input class="range-slider__range" type="range" value="" id="Rich_Web_Sl_SC_TFS" name="" min="8" max="48">
							<span class="range-slider__value" id="Rich_Web_Sl_SC_TFS_Span">0</span>
						</div>
					</td>
					<td>
						<select class="rich_web_Select_Menu" id="Rich_Web_Sl_SC_TFF" name="">
							<?php for($i=0;$i<count($Rich_WebFontCount);$i++){ ?> 
								<option value="<?php echo $Rich_WebFontCount[$i]->Font_family;?>"><?php echo $Rich_WebFontCount[$i]->Font_family;?></option>
							<?php }?>
						</select>
				...
				<tr>
					...
					<td>
						<div class="range-slider">  
							<input class="range-slider__range" type="range" value="" id="Rich_Web_Sl_SC_Pop_BW" name="" min="0" max="15">
				...
				<tr>
					<td>
						<label class="switch switch-light">
							<input class="switch-input" type="checkbox" name="" id="Rich_Web_Sl_SC_Pop_BoxShType"/>
							<span class="switch-label" data-on="1" data-off="2"></span> 
							<span class="switch-handle"></span> 
						</label>
					</td>
					<td>
						<div class="range-slider">  
							<input class="range-slider__range" type="range" value="" id="Rich_Web_Sl_SC_Pop_BoxSh" name="" min="0" max="50">
				...
				<tr>
					...
					<td>
						<div class="range-slider">  
							<input class="range-slider__range" type="range" value="" id="Rich_Web_Sl_SC_L_FS" name="" min="8" max="48">
							<span class="range-slider__value" id="Rich_Web_Sl_SC_L_FS_Span">0</span>
						</div>
					</td>
					<td>
						<div class="range-slider">  
							<input class="range-slider__range" type="range" value="" id="Rich_Web_Sl_SC_L_BW" name="" min="0" max="10">
				...
				<tr>
					...
					<td>
						<div class="range-slider">  
							<input class="range-slider__range" type="range" value="" id="Rich_Web_Sl_SC_L_BR" name="" min="0" max="100">
				...
				<tr>
					...
					<td>
						<input type="text" class="rich_web_Select_Menu" name="" id="Rich_Web_Sl_SC_L_Text" value="">
					</td>
					<td>
				...
				<tr>
					<td>
						<select class="rich_web_Select_Menu" id="Rich_Web_Sl_SC_L_FF" name="">
							<?php for($i=0;$i<count($Rich_WebFontCount);$i++){ ?> 
								<option value="<?php echo $Rich_WebFontCount[$i]->Font_family;?>"><?php echo $Rich_WebFontCount[$i]->Font_family;?></option>
							<?php }?>
						</select>
				...
				<tr>
					...
					<td>
						<div class="range-slider">  
							<input class="range-slider__range" type="range" value="" id="Rich_Web_Sl_SC_PI_FS" name="" min="8" max="48">
							<span class="range-slider__value" id="Rich_Web_Sl_SC_PI_FS_Span">0</span>
						</div>
					</td>
					<td>
						<div class="range-slider">  
							<input class="range-slider__range" type="range" value="" id="Rich_Web_Sl_SC_PI_BW" name="" min="0" max="10">
				...
				<tr>
					...
					<td>
						<div class="range-slider">  
							<input class="range-slider__range" type="range" value="" id="Rich_Web_Sl_SC_PI_BR" name="" min="0" max="100">
				...
				<tr>
					...
					<td>
						<input type="text" class="rich_web_Select_Menu" name="" id="Rich_Web_Sl_SC_PI_Text" value="">
					</td>
					<td>
				...
				<tr>
					<td>
						<select class="rich_web_Select_Menu" id="Rich_Web_Sl_SC_PI_FF" name="">
							<?php for($i=0;$i<count($Rich_WebFontCount);$i++){ ?> 
								<option value="<?php echo $Rich_WebFontCount[$i]->Font_family;?>"><?php echo $Rich_WebFontCount[$i]->Font_family;?></option>
							<?php }?>
						</select>
				...
				<tr>
					...
					<td>
						<div class="range-slider">  
							<input class="range-slider__range" type="range" value="" id="Rich_Web_Sl_SC_Arr_FS" name="" min="8" max="48">
							<span class="range-slider__value" id="Rich_Web_Sl_SC_Arr_FS_Span">0</span>
						</div>
					</td>
					<td>
						<div class="range-slider">  
							<input class="range-slider__range" type="range" value="" id="Rich_Web_Sl_SC_Arr_BW" name="" min="0" max="10">
				...
				<tr>
					...
					<td>
						<div class="range-slider">  
							<input class="range-slider__range" type="range" value="" id="Rich_Web_Sl_SC_Arr_BR" name="" min="0" max="100">
				...
				<tr>
					...
					<td>
						<select class="rich_web_Select_Menu" id="Rich_Web_Sl_SC_Arr_FF" name="">
							<?php for($i=0;$i<count($Rich_WebFontCount);$i++){ ?> 
								<option value="<?php echo $Rich_WebFontCount[$i]->Font_family;?>"><?php echo $Rich_WebFontCount[$i]->Font_family;?></option>
							<?php }?>
						</select>
				...
				<tr>
					<td>
						<input type="text" class="rich_web_Select_Menu" name="" id="Rich_Web_Sl_SC_Arr_Next" value="">
					</td>
					<td>
						<input type="text" class="rich_web_Select_Menu" name="" id="Rich_Web_Sl_SC_Arr_Prev" value="">
					</td>
					<td colspan="2"></td>
				</tr>
				<tr>
				...
				<tr>
					<td>
						<div class="range-slider">  
							<input class="range-slider__range" type="range" value="" id="Rich_Web_Sl_SC_PCI_FS" name="" min="8" max="48">
			...
			<table class="rich_web_SaveSl_Table_2 rich_web_SaveSl_Table_2_6" style='display:none;'>
				...
				<tr>
					...
					<td>
						<label class="switch switch-light">
							<input class="switch-input" type="checkbox" name="" id="Rich_Web_Sl_FS_SVis"/>
							<span class="switch-label" data-on="On" data-off="Off"></span> 
							<span class="switch-handle"></span> 
						</label>
					</td>
				...
				<tr>
					...
					<td>
						<label class="switch switch-light">
							<input class="switch-input" type="checkbox" name="" id="Rich_Web_Sl_FS_I_BoxShShow"/>
							<span class="switch-label" data-on="On" data-off="Off"></span> 
							<span class="switch-handle"></span> 
						</label>
					</td>
					<td>
						<label class="switch switch-light">
							<input class="switch-input" type="checkbox" name="" id="Rich_Web_Sl_FS_I_BoxShType"/>
							<span class="switch-label" data-on="1" data-off="2"></span> 
							<span class="switch-handle"></span> 
						</label>
					</td>
				...
				<tr>
					<td>
						<div class="range-slider">  
							<input class="range-slider__range" type="range" value="" id="Rich_Web_Sl_FS_I_BoxSh" name="" min="0" max="50">
				...
				<tr>
					...
					<td>
						<select class="rich_web_Select_Menu" id="Rich_Web_Sl_FS_T_FF" name="">
							<?php for($i=0;$i<count($Rich_WebFontCount);$i++){ ?> 
								<option value="<?php echo $Rich_WebFontCount[$i]->Font_family;?>"><?php echo $Rich_WebFontCount[$i]->Font_family;?></option>
							<?php }?>
						</select>
				...
				<tr>
					...
					<td>
						<div class="range-slider">  
							<input class="range-slider__range" type="range" value="" id="Rich_Web_Sl_FS_Nav_BW" name="" min="0" max="5">
				...
				<tr>
					...
					<td>
						<div class="range-slider">  
							<input class="range-slider__range" type="range" value="" id="Rich_Web_Sl_FS_Nav_BR" name="" min="0" max="15">
				...
				<tr>
					...
					<td>
						<div class="range-slider">  
							<input class="range-slider__range" type="range" value="" id="Rich_Web_Sl_FS_Arr_S" name="" min="8" max="80">
			...
			<table class="rich_web_SaveSl_Table_2 rich_web_SaveSl_Table_2_7" style='display:none;'>
				...
				<tr>
					<td>
						<div class="range-slider">  
							<input class="range-slider__range" type="range" value="" id="Rich_Web_Sl_DS_TFS" name="" min="8" max="48">
							<span class="range-slider__value" id="Rich_Web_Sl_DS_TFS_Span">0</span>
						</div>
					</td>
					<td>
						<select class="rich_web_Select_Menu" id="Rich_Web_Sl_DS_TFF" name="">
							<?php for($i=0;$i<count($Rich_WebFontCount);$i++){ ?> 
								<option value="<?php echo $Rich_WebFontCount[$i]->Font_family;?>"><?php echo $Rich_WebFontCount[$i]->Font_family;?></option>
							<?php }?>
						</select>
				...
				<tr>
					<td>
						<div class="range-slider">  
							<input class="range-slider__range" type="range" value="" id="Rich_Web_Sl_DS_DFS" name="" min="8" max="48">
							<span class="range-slider__value" id="Rich_Web_Sl_DS_DFS_Span">0</span>
						</div>
					</td>
					<td>
						<select class="rich_web_Select_Menu" id="Rich_Web_Sl_DS_DFF" name="">
							<?php for($i=0;$i<count($Rich_WebFontCount);$i++){ ?> 
								<option value="<?php echo $Rich_WebFontCount[$i]->Font_family;?>"><?php echo $Rich_WebFontCount[$i]->Font_family;?></option>
							<?php }?>
						</select>
					...
					<td>
						<input type='text' class='alpha-color-picker' id='Rich_Web_Sl_DS_DC' name="" value="">
					</td>
					<td></td>
				</tr>
				<tr>
				...
				<tr>
					<td>
						<div class="range-slider">  
							<input class="range-slider__range" type="range" value="" id="Rich_Web_Sl_DS_LFS" name="" min="8" max="48">
							<span class="range-slider__value" id="Rich_Web_Sl_DS_LFS_Span">0</span>
						</div>
					</td>
					<td>
						<select class="rich_web_Select_Menu" id="Rich_Web_Sl_DS_LFF" name="">
							<?php for($i=0;$i<count($Rich_WebFontCount);$i++){ ?> 
								<option value="<?php echo $Rich_WebFontCount[$i]->Font_family;?>"><?php echo $Rich_WebFontCount[$i]->Font_family;?></option>
							<?php }?>
						</select>
				...
				<tr>
					<td>
						<div class="range-slider">  
							<input class="range-slider__range" type="range" value="" id="Rich_Web_Sl_DS_LBW" name="" min="0" max="10">
					...
					<td>
						<div class="range-slider">  
							<input class="range-slider__range" type="range" value="" id="Rich_Web_Sl_DS_LBR" name="" min="0" max="100">
				...
				<tr>
					...
					<td>
						<input type="text" class="rich_web_Select_Menu" name="" id="Rich_Web_Sl_DS_LT" value="">
					</td>
					<td></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td>
						<input type="text" class="rich_web_Select_Menu" name="" id="Rich_Web_Sl_DS_Arr_LT" value="">
					</td>
					<td>
						<input type="text" class="rich_web_Select_Menu" name="" id="Rich_Web_Sl_DS_Arr_RT" value="">
					</td>
					<td>
				...
				<tr>
					...
					<td>
						<div class="range-slider">  
							<input class="range-slider__range" type="range" value="" id="Rich_Web_Sl_DS_Arr_BW" name="" min="0" max="10">
				...
				<tr>
					<td>
						<div class="range-slider">  
							<input class="range-slider__range" type="range" value="" id="Rich_Web_Sl_DS_Arr_BR" name="" min="0" max="100">
				...
				<tr>
					...
					<td>
						<div class="range-slider">  
							<input class="range-slider__range" type="range" value="" id="Rich_Web_Sl_DS_Nav_BW" name="" min="0" max="10">
				...
				<tr>
					...
					<td>
						<div class="range-slider">  
							<input class="range-slider__range" type="range" value="" id="Rich_Web_Sl_DS_Nav_BR" name="" min="0" max="50">
			...
			<table class="rich_web_SaveSl_Table_2 rich_web_SaveSl_Table_2_8" style='display:none;'>
				...
				<tr>
					...
					<td>
						<label class="switch switch-light">
							<input class="switch-input" type="checkbox" name="" id="Rich_Web_Sl_TSL_BoxShShow"/>
							<span class="switch-label" data-on="On" data-off="Off"></span> 
							<span class="switch-handle"></span> 
						</label>
					</td>
					<td>
						<label class="switch switch-light">
							<input class="switch-input" type="checkbox" name="" id="Rich_Web_Sl_TSL_BoxShType"/>
							<span class="switch-label" data-on="1" data-off="2"></span> 
							<span class="switch-handle"></span> 
						</label>
					</td>
				...
				<tr>
					<td>
						<div class="range-slider">  
							<input class="range-slider__range" type="range" value="" id="Rich_Web_Sl_TSL_BoxSh" name="" min="0" max="50">
				...
				<tr>
					...
					<td>
						<div class="range-slider">  
							<input class="range-slider__range" type="range" value="" id="Rich_Web_Sl_TSL_Nav_BR" name="" min="0" max="20">
				...
				<tr>
					<td>
						<div class="range-slider">  
							<input class="range-slider__range" type="range" value="" id="Rich_Web_Sl_TSL_SS_BR" name="" min="0" max="20">
				...
				<tr>
					...
					<td>
						<div class="range-slider">  
							<input class="range-slider__range" type="range" value="" id="Rich_Web_Sl_TSL_Arr_S" name="" min="0" max="100">
				...
				<tr>
					...
					<td>
						<div class="range-slider">  
							<input class="range-slider__range" type="range" value="" id="Rich_Web_Sl_TSL_Pop_BW" name="" min="0" max="15">
				...
				<tr>
					<td>
						<div class="range-slider">  
							<input class="range-slider__range" type="range" value="" id="Rich_Web_Sl_TSL_Pop_BR" name="" min="0" max="50">
				...
				<tr>
					<td>
						<div class="range-slider">  
							<input class="range-slider__range" type="range" value="" id="Rich_Web_Sl_TSL_TFS" name="" min="8" max="48">
							<span class="range-slider__value" id="Rich_Web_Sl_TSL_TFS_Span">0</span>
						</div>
					</td>
					<td>
						<select class="rich_web_Select_Menu" id="Rich_Web_Sl_TSL_TFF" name="">
							<?php for($i=0;$i<count($Rich_WebFontCount);$i++){ ?> 
								<option value="<?php echo $Rich_WebFontCount[$i]->Font_family;?>"><?php echo $Rich_WebFontCount[$i]->Font_family;?></option>
							<?php }?>
						</select>
				...
				<tr>
					...
					<td>
						<div class="range-slider">  
							<input class="range-slider__range" type="range" value="" id="Rich_Web_Sl_TSL_Pop_ArrS" name="" min="8" max="48">
				...
				<tr>
					...
					<td>
						<div class="range-slider">  
							<input class="range-slider__range" type="range" value="" id="Rich_Web_Sl_TSL_CIS" name="" min="8" max="48">
			...
			<table class="rich_web_SaveSl_Table_2 rich_web_SaveSl_Table_2_9" style='display:none;'>
				...
				<tr>
					...
					<td>
						<div class="range-slider">  
							<input class="range-slider__range" type="range" value="" id="Rich_Web_AcSL_BSh" name="" min="0" max="50">
				...
				<tr>
					<td>
						<div class="range-slider">  
							<input class="range-slider__range" type="range" value="" id="Rich_Web_AcSL_Title_FS" name="" min="8" max="36">
							<span class="range-slider__value" id="Rich_Web_AcSL_Title_FS_Span">0</span>
						</div>
					</td>
					<td>
						<select class="rich_web_Select_Menu" id="Rich_Web_AcSL_Title_FF" name="">
							<?php for($i=0;$i<count($Rich_WebFontCount);$i++){ ?> 
								<option value="<?php echo $Rich_WebFontCount[$i]->Font_family;?>"><?php echo $Rich_WebFontCount[$i]->Font_family;?></option>
							<?php }?>
						</select>
					...
					<td>
						<div class="range-slider">  
							<input class="range-slider__range" type="range" value="" id="Rich_Web_AcSL_Title_TSh" name="" min="0" max="5">
				...
				<tr>
					<td>
						<input type='text' class='alpha-color-picker' id='Rich_Web_AcSL_Title_TShC' name="" value="">
					</td>
					<td>
				...
				<tr>
					<td>
						<div class="range-slider">  
							<input class="range-slider__range" type="range" value="" id="Rich_Web_AcSL_Link_FS" name="" min="8" max="36">
							<span class="range-slider__value" id="Rich_Web_AcSL_Link_FS_Span">0</span>
						</div>
					</td>
					<td>
						<select class="rich_web_Select_Menu" id="Rich_Web_AcSL_Link_FF" name="">
							<?php for($i=0;$i<count($Rich_WebFontCount);$i++){ ?> 
								<option value="<?php echo $Rich_WebFontCount[$i]->Font_family;?>"><?php echo $Rich_WebFontCount[$i]->Font_family;?></option>
							<?php }?>
						</select>
					...
					<td>
						<div class="range-slider">  
							<input class="range-slider__range" type="range" value="" id="Rich_Web_AcSL_Link_TSh" name="" min="0" max="5">
				...
				<tr>
					<td>
						<input type='text' class='alpha-color-picker' id='Rich_Web_AcSL_Link_TShC' name="" value="">
					</td>
					<td>
						<input type='text' class='alpha-color-picker' id='Rich_Web_AcSL_Link_BgC' name="" value="">
					</td>
					<td>
						<input type='text' id='Rich_Web_AcSL_Link_Text' name="" value="">
					</td>
					<td></td>
				</tr>
				<tr>
			...
			<table class="rich_web_SaveSl_Table_2 rich_web_SaveSl_Table_2_10" style='display:none;'>
				...
				<tr>
					...
					<td>
						<div class="range-slider">  
							<input class="range-slider__range" type="range" value="" id="Rich_Web_AnSL_BSh" name="" min="0" max="30">
				...
				<tr>
					...
					<td>
						<select class="rich_web_Select_Menu" id='Rich_Web_AnSL_N_BS' name="">
							<option value='Type 1'> Type 1 </option>
							<option value='Type 2'> Type 2 </option>
						</select>
					</td>
				...
				<tr>
					<td>
						<div class="range-slider">  
							<input class="range-slider__range" type="range" value="" id="Rich_Web_AnSL_T_FS" name="" min="8" max="36">
							<span class="range-slider__value" id="Rich_Web_AnSL_T_FS_Span">0</span>
						</div>
					</td>
					<td>
						<select class="rich_web_Select_Menu" id="Rich_Web_AnSL_T_FF" name="">
							<?php for($i=0;$i<count($Rich_WebFontCount);$i++){ ?> 
								<option value="<?php echo $Rich_WebFontCount[$i]->Font_family;?>"><?php echo $Rich_WebFontCount[$i]->Font_family;?></option>
							<?php }?>
						</select>
				...
				<tr>
					...
					<td>
						<div class="range-slider">  
							<input class="range-slider__range" type="range" value="" id="Rich_Web_AnSL_N_S" name="" min="5" max="30">
							<span class="range-slider__value" id="Rich_Web_AnSL_T_Sh_Span">0</span>
						</div>
					</td>
					<td>
						<div class="range-slider">  
							<input class="range-slider__range" type="range" value="" id="Rich_Web_AnSL_N_BW" name="" min="0" max="5">
							<span class="range-slider__value" id="Rich_Web_AnSL_T_Sh_Span">0</span>
						</div>
					</td>
					<td>
				...
				<tr>
					<td>
						<label class="switch switch-light">
							<input class="switch-input" type="checkbox" name="" id="Rich_Web_AnSL_Ic_Sh"/>
							<span class="switch-label" data-on="On" data-off="Off"></span> 
							<span class="switch-handle"></span> 
						</label>
					</td>
				...
				<tr>
					...
					<td>
						<div class="range-slider">  
							<input class="range-slider__range" type="range" value="" id="Rich_Web_AnSL_Ic_S" name="" min="10" max="80">
